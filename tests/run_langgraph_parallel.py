...
# Configuration
MAX_CONCURRENT_AGENTS = 5  # Adjust based on your system resources
...
output_dir = "/fs-computility/mabasic/qibiqing/marti-project/MARTI-Dev-Git/local/GAIA/outputs/Qwen3-32B-fix"
