...
TASK="search_r1"
ALGO="tool-search-r1-async-ready-task-gspo"
...
ray job submit --address="http://localhost:8265" \
    ...
    default_agent.train_batch_size=1024 \
    ...
    default_agent.eps_clip=0.2 \
    default_agent.clip_eps_high=0.2 \
    ...
    extra_eval_dir="${ROOT_DIR}/local/search-r1-bench" \
