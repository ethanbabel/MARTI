...
TASK="math"
ALGO="tool-code-eval-only-temp0.6"
...
export RAY_TMPDIR=/fs-computility/mabasic/qibiqing/ray_temp

# Set other Ray configurations
...
ray job submit --address="http://localhost:8265" \
    ...
    -- python -m marti.cli.commands.train --config-name "tool_code" \
    agent_workflow="tool" \
    default_agent.ref_num_nodes=1 \
    default_agent.enable_thinking=False \
    ...
    default_agent.save_steps=50 \
    default_agent.eval_steps=20 \
    ...
    default_agent.lr_warmup_steps=20 \
