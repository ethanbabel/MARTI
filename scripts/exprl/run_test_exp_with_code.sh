...
ray job submit --address="http://localhost:8265" \
    ...
    -- python -m marti.cli.commands.train --config-name "ma_exp_with_code" \
    async_workflow=True \
    ...
    workflow_func_path="marti/worlds/workflows/experience_with_tool_workflow.py" \
    ...
    wandb_run_name="${EXP}" \
    extra_eval_tasks=["aime24","aime25","math500"] \
